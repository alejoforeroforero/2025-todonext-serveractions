  ...
  return (
    <div className="flex flex-col items-center justify-center min-h-[60vh] px-4">
      ...
      <p className="mb-8 text-lg text-gray-700 dark:text-gray-300 max-w-xl text-center">
        ...
        This website is a demo that lets you create, read, update, and delete tasks. It’s designed to showcase how I work with this technologies and to demonstrate my skills as a developer. You can view the code on GitHub: https://github.com/alejoforeroforero/2025-portafolio-next
      </p>
